...
export default async function Home() {
  ...
  const fallbackProjects = [
    { id: '1', title: "Interactive 3D Human Body Explorer", category: "Web Development", description: "Architected an interactive 3D anatomy visualization tool with real-time rotation, zoom, and structure inspection.", tech: ["WebGL", "Three.js"], link: null, imageFallback: "/hamdard.png" },
    { id: '2', title: "Ferrari Digital Experience", category: "Web Development", description: "Designed a high-end vehicle showcase inspired by minimalist Apple and Ferrari digital aesthetics.", tech: ["Framer Motion", "CSS3"], link: null, imageFallback: "/hamdard.png" },
    { id: '3', title: "Neurosurgeon Medical Portfolio", category: "Web Development", description: "Developed a custom healthcare web application with dynamic patient consultation forms.", tech: ["React", "Node.js"], link: null, imageFallback: "/hamdard.png" },
